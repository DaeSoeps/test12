...
begin
    ...
    begin
        ...
        sql.Add(' where STNameKor like :STNameKor');
...
//    end;
    ...
    begin
        ...
        Params.ParamByName('STNameKor').AsWideString := STNameKor.Text;
        Params.ParamByName('STKor'    ).AsInteger:= StrToInt(STKor    .Text);
        Params.ParamByName('STEng'    ).AsInteger:= StrToInt(STEng    .Text);
        Params.ParamByName('STMath'   ).AsInteger:= StrToInt(STMath   .Text);
